...
시작하기 전에 이 글은 제가 Promise를 공부하고 기억해야겠다 싶은 내용을 정리한 내용입니다. Promise를 아예 모르시는 분이 보기에는 거북할 수 있으니 저보다 훨씬 친절하게 잘 쓰신 아래의 블로그를 먼저 보시기 바랍니다.

완전 처음이시다. => https://joshua1988.github.io/web-development/javascript/javascript-asynchronous-operation/
저보다 더 잘 쓴 블로그 =>  https://ko.javascript.info/async
